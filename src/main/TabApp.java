...
public class TabApp extends GuiHelper implements Observer {
	...
	protected TabAppEventHandler event;
	/**
	 * toolkit for frameImage
	 */
	private Icon iconBlackSheep;
	/**
...
//	protected JMenu menuFont;
	...
	public TabApp() {
//		checkOS();
		iconBlackSheep = new ImageIcon("InkyBuckTrans.png");
		manuscript = new Manuscript(this, iconBlackSheep);
		event = new TabAppEventHandler(this);
...
//	}
	...
	public void init() {
		 ...
		 * Frame features
		 */
		setTitle("RAM's Tab Creator");
		setIconImage(imageFrameIcon);
		setSize(myPrefs.getSize());
		if(myPrefs.getLocation().getX() != 0 && myPrefs.getLocation().getY() != 0){
			setLocation(myPrefs.getLocation());
		}else{
			setLocation(this.centerGUI());//if (0,0)
		}
		setVisible(true);
		 ...
		 * Container features
		 */
		Container tabContainer = getContentPane();
...
//		menuBar.add(menuFont);
	...
	public int newMeasureStringsPrompt() {
		...
		strings = JOptionPane.showOptionDialog(this, "How many strings?",
	 ...
	 */
	public void newTab() {
		int o = JOptionPane.showConfirmDialog(this, "Do you want to save this Tab?",
...
//		validate();
	...
	public void save() {
		if(!manuscript.saveTab()){
			...
			JOptionPane.showConfirmDialog(this, "Tab has been saved.",
	...
	public void write() {
		if(!manuscript.writeTab()){
			...
			JOptionPane.showConfirmDialog(this, "Tab has been written.",
					"Success!", JOptionPane.PLAIN_MESSAGE,
					JOptionPane.INFORMATION_MESSAGE, iconBlackSheep);
		}
	}
	...
	public boolean openTabPrompt() {
		...
		if (chooser.showOpenDialog(null) == JFileChooser.CANCEL_OPTION) {
			...
			manuscript.closeTab();
			setTitle("RAM's Tab Creator           " + "Loading.....");
			panelCenter.removeAll();
			panelCenter.add(manuscript.getTabbedPane(), BorderLayout.CENTER);
...
//	}
	...
	public void setTabName() {
		...
		String name = (String) JOptionPane.showInputDialog(this, "Currently: "
	...
	public void showSaveMessage() {
		int o = JOptionPane.showConfirmDialog(this, "Would you like to save?",
	...
	public void updateInput(String input) {
		setTitle("RAM's Tab Creator           " + input);
	}
